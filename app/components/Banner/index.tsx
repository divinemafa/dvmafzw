                    ...
                    <div className='grid grid-cols-1 lg:grid-cols-12 my-16'>
                        ...
                        <div className='col-span-7'>
                            ...
                            <div className='flex align-middle justify-center md:justify-start'>
                                ...
                                <button onClick={() => window.open('https://dexscreener.com/solana/Tt0T0000T00000t000000000000tT', '_blank')} className='bg-transparent flex justify-center items-center text-white'><Image src={'/images/Banner/playbutton.svg'} alt="button-image" className='mr-3' width={47} height={47} />View Chart</button>
                            </div>
                        </div>
                            ...
                            {isOpen && (
                                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-75" onClick={() => setOpen(false)}>
                                    <div className="relative w-full max-w-4xl h-96" onClick={(e) => e.stopPropagation()}>
                                        <iframe
                                            src="https://dexscreener.com/solana/Tt0T0000T00000t000000000000tT?embed=1&theme=dark"
                                            width="100%"
                                            height="100%"
                                            frameBorder="0"
                                            allowFullScreen
