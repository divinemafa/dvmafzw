    ...
    return (
        <div className="simple-bg relative">
            ...
            <div className="mx-auto max-w-5xl py-24 px-6">
                <h3 className="text-center text-offwhite text-3xl lg:text-5xl font-semibold mb-6">Ready to Join the Revolution? <br /> Get BITCOIN MASCOT tokens</h3>
                ...
                <div className="flex justify-center ">
                    <button className='text-xl font-semibold text-white py-4 px-6 lg:px-12 navbutton'>Buy BITCOIN MASCOT Now</button>
                </div>
            </div>
