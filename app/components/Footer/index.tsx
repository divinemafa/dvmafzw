      ...
      <div className="mx-auto max-w-2xl mt-64 pb-16 px-4 sm:px-6 lg:max-w-7xl lg:px-8">
        <div className="mt-24 grid grid-cols-1 gap-y-10 gap-x-16 sm:grid-cols-2 lg:grid-cols-12 xl:gap-x-8">
          ...
          <div className="col-span-4">
            ...
            <h4 className="text-offwhite text-sm font-normal mb-6 flex gap-2"><Image src={'/images/Footer/number.svg'} alt="contract-icon" width={20} height={20} style={{ width: 'auto', height: 'auto' }} />bitcoin22u2TsTcfiiAkxTi3VwDm6wBCcdnw9SBF37GGfEg</h4>
